    ...
    handleChangeSelect = async (selectedOption) => {
        ...
        if (res && res.errCode == 0 && res.data && res.data.Markdown) {
            ...
            let addressClinic = '', nameClinic = '', note = '', paymentId = '',
                priceId = '', clinicId = '', provinceId = '', specialtyId = '', selectedPayment = '', selectedPrice = '',
        ...
        return (
            <div className='manage-doctor-container'>
                ...
                <div className='row'>
                    ...
                    <div className='col-4 form-group'>
                        <label><FormattedMessage id="admin.manage-doctor.select-doctor-hospital" /></label>
                        <Select
                            value={this.state.selectedClinic}
                            onChange={this.handleChangeSelectDoctorInfor}
                            options={this.state.listClinic}
                            placeholder={<FormattedMessage id="admin.manage-doctor.select-doctor-hospital" />}
                            name="selectedClinic" />
                    </div>
                </div>
